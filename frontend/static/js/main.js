...
$(document).ready(function () {
    ...
    //         var j;
    //         for (j = 0; j < reg.regional.length; j++) {
    //             region[j] = reg.regional[j];
    //         }
    //         autocomplete(document.getElementById("region"), region);
    //     }
    // });
});
...
//         if (itemName.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
...
//           b.innerHTML += "<input type='hidden' value='" + itemName + "'>";
